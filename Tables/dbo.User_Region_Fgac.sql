...
GO
ALTER TABLE [dbo].[User_Region_Fgac] WITH NOCHECK ADD CONSTRAINT [FK_URFG_REGN] FOREIGN KEY ([REGN_PRVN_CNTY_CODE], [REGN_PRVN_CODE], [REGN_CODE]) REFERENCES [dbo].[Region] ([PRVN_CNTY_CODE], [PRVN_CODE], [CODE])
GO
