...
GO
ALTER TABLE [dbo].[Expense_Cash] WITH NOCHECK ADD CONSTRAINT [FK_EXCS_REGN] FOREIGN KEY ([REGN_PRVN_CNTY_CODE], [REGN_PRVN_CODE], [REGN_CODE]) REFERENCES [dbo].[Region] ([PRVN_CNTY_CODE], [PRVN_CODE], [CODE]) ON DELETE CASCADE
GO
