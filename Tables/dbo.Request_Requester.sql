...
GO
ALTER TABLE [dbo].[Request_Requester] ADD CONSTRAINT [FK_RQRQ_RQTP] FOREIGN KEY ([RQTP_CODE]) REFERENCES [dbo].[Request_Type] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
GO
ALTER TABLE [dbo].[Request_Requester] ADD CONSTRAINT [FK_RQRQ_RQTT] FOREIGN KEY ([RQTT_CODE]) REFERENCES [dbo].[Requester_Type] ([CODE]) ON DELETE CASCADE ON UPDATE CASCADE
GO
