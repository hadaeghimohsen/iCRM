...
[MSTT_DESC] [nvarchar] (500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
;
GO
ALTER TABLE [dbo].[Step_History_Summery] ADD CONSTRAINT [SHIS_PK] PRIMARY KEY CLUSTERED  ([RQST_RQID], [RWNO]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Step_History_Summery] WITH NOCHECK ADD CONSTRAINT [FK_SHIS_MSTT] FOREIGN KEY ([SSTT_MSTT_CODE], [SSTT_MSTT_SUB_SYS]) REFERENCES [dbo].[Main_State] ([CODE], [SUB_SYS]) ON DELETE CASCADE
GO
