...
GO
ALTER TABLE [dbo].[Sub_Unit] ADD CONSTRAINT [FK_SUNT_BUNT] FOREIGN KEY ([BUNT_DEPT_ORGN_CODE], [BUNT_DEPT_CODE], [BUNT_CODE]) REFERENCES [dbo].[Base_Unit] ([DEPT_ORGN_CODE], [DEPT_CODE], [CODE])
GO
