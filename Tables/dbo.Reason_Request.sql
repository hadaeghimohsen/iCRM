...
GO
ALTER TABLE [dbo].[Reason_Request] ADD CONSTRAINT [FK_RSRQ_RQRO] FOREIGN KEY ([RQRO_RQST_RQID], [RQRO_RWNO]) REFERENCES [dbo].[Request_Row] ([RQST_RQID], [RWNO]) ON DELETE CASCADE
GO
