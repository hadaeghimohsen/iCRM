...
[SSTT_DESC] [nvarchar] (500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
;
GO
ALTER TABLE [dbo].[Step_History_Detail] ADD CONSTRAINT [SHID_PK] PRIMARY KEY CLUSTERED  ([SHIS_RQST_RQID], [SHIS_RWNO], [RWNO]) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[Step_History_Detail] WITH NOCHECK ADD CONSTRAINT [FK_SHID_SSTT] FOREIGN KEY ([SSTT_MSTT_CODE], [SSTT_MSTT_SUB_SYS], [SSTT_CODE]) REFERENCES [dbo].[Sub_State] ([MSTT_CODE], [MSTT_SUB_SYS], [CODE]) ON DELETE CASCADE
GO
