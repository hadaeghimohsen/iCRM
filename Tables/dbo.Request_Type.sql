...
[RQTP_TYPE] [varchar] (3) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'آیا نوع درخواست به گونه ای می باشد که می توان جدول مشارکتی برای دیگر کاربران در نظر گرفت', 'SCHEMA', N'dbo', 'TABLE', N'Request_Type', 'COLUMN', N'COLB_STAT'
GO
EXEC sp_addextendedproperty N'MS_Description', N'بعد از ذخیره شدن اطلاعات برای یادآوری در سیستم ذخیره گردد', 'SCHEMA', N'dbo', 'TABLE', N'Request_Type', 'COLUMN', N'RMND_STAT'
GO
EXEC sp_addextendedproperty N'MS_Description', N'ثبت نام های اولیه که باید از جدول اطلاعات عمومی با رکورد 002 اعلام هزینه کرد', 'SCHEMA', N'dbo', 'TABLE', N'Request_Type', 'COLUMN', N'RQTP_TYPE'
GO
EXEC sp_addextendedproperty N'MS_Description', N'آیا درآمد در حسابداری قرار گیرد؟', 'SCHEMA', N'dbo', 'TABLE', N'Request_Type', 'COLUMN', N'SAVE_PYMT_ACNT'
GO
