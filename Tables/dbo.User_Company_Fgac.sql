CREATE TABLE [dbo].[User_Company_Fgac]
(
...
BEGIN
   ...
   IF EXISTS(
      SELECT *
        FROM INSERTED S, User_Company_Fgac T
...
;
GO
ALTER TABLE [dbo].[User_Company_Fgac] ADD CONSTRAINT [PK_UCFG] PRIMARY KEY CLUSTERED  ([FGA_CODE]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[User_Company_Fgac] ADD CONSTRAINT [FK_UCFG_COMP] FOREIGN KEY ([COMP_CODE]) REFERENCES [dbo].[Company] ([CODE]) ON DELETE CASCADE
GO
