...
BEGIN
   ...
   DECLARE C#NewRegn CURSOR FOR
      SELECT dbo.GET_PSTR_U(Code, 3) FROM INSERTED
...
GO
ALTER TABLE [dbo].[Region] ADD CONSTRAINT [FK_REGN_PRVN] FOREIGN KEY ([PRVN_CNTY_CODE], [PRVN_CODE]) REFERENCES [dbo].[Province] ([CNTY_CODE], [CODE]) ON DELETE CASCADE ON UPDATE CASCADE
GO
