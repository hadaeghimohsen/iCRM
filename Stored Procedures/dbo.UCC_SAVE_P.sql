...
BEGIN
	...
	*/
	...
	BEGIN TRY
      ...
      IF NOT EXISTS(SELECT * FROM Member_Ship WHERE RQRO_RQST_RQID = @Rqid AND RQRO_RWNO = @RqroRwno AND SERV_FILE_NO = @FileNo AND RECT_CODE = '004')
