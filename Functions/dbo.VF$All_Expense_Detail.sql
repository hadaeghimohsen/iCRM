...
-- =============================================
CREATE FUNCTION [dbo].[VF$All_Expense_Detail]
(	
...
(
	...
	SELECT RQTP.CODE AS RQTP_CODE, RQTP.RQTP_DESC, RQTP.MUST_LOCK AS RQTP_MUST_LOCK, RQTT.RQTT_DESC, RQTT.CODE AS RQTT_CODE, RQRQ.SUB_SYS AS RQRQ_SUB_SYS, 
          RQRQ.CODE AS RQRQ_CODE, RQRQ.PERM_STAT AS RQRQ_PERM_STAT, EPIT.EPIT_DESC, EPIT.TYPE AS EPIT_TYPE, EXTP.EXTP_DESC, EXTP.CODE AS EXTP_CODE, 
          ...
          EXPN.EXTR_PRCT AS EXPN_EXTR_PRCT, EXPN.EXPN_STAT, EXPN.ADD_QUTS, TRFD.NAME AS TRFD_NAME, TRFD.TRFD_DESC, TRFD.CODE AS TRFD_CODE, BTRF.CODE AS BTRF_CODE, BTRF.BTRF_DESC, 
          REGL_ACNT.TYPE AS REGL_ACNT_TYPE, REGL_ACNT.REGL_STAT AS REGL_ACNT_STAT
    ...
    WHERE (RQRQ.PERM_STAT      = '002') 
      ...
      AND (@BTRFCode IS NULL OR BTRF.CODE      = @BTRFCode)
      AND (@TRFDCode IS NULL OR TRFD.CODE      = @TRFDCode)
)
GO
